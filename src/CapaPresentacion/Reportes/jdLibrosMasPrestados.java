 ...
 */
public class jdLibrosMasPrestados extends javax.swing.JDialog {

    /**
     * Creates new form jdLibrosMasPrestados
     */
    public jdLibrosMasPrestados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            JRViewer vistaRPT = new clsReporte().reporteInterno("rptLibrosMasPrestados.jasper", param);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdLibrosMasPrestados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdLibrosMasPrestados dialog = new jdLibrosMasPrestados(new javax.swing.JFrame(), true);
