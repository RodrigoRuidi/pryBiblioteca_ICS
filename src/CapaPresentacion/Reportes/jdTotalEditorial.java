 ...
 */
public class jdTotalEditorial extends javax.swing.JDialog {

    /**
     * Creates new form jdTotalEditorial
     */
    public jdTotalEditorial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
            ...
            JRViewer vistaRPT = new clsReporte().reporteInterno("rptTotalPorEditorial.jasper", param);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdTotalEditorial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdTotalEditorial dialog = new jdTotalEditorial(new javax.swing.JFrame(), true);
