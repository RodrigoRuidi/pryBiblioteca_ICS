 ...
 */
public class jdRepPorcentajeLibrosPrestadosArea extends javax.swing.JDialog {

    /**
     * Creates new form jdRepPorcentajeLibrosPrestadosArea
     */
    public jdRepPorcentajeLibrosPrestadosArea(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            JRViewer vistaRPT = new clsReporte().reporteInterno("rptPorcentajeLibrosPrestadosArea.jasper", null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdRepPorcentajeLibrosPrestadosArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdRepPorcentajeLibrosPrestadosArea dialog = new jdRepPorcentajeLibrosPrestadosArea(new javax.swing.JFrame(), true);
