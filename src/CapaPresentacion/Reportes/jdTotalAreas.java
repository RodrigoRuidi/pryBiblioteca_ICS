 ...
 */
public class jdTotalAreas extends javax.swing.JDialog {

    /**
     * Creates new form jdTotalAreas
     */
    public jdTotalAreas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            JRViewer vistaRPT = new clsReporte().reporteInterno("rptTotalPorAreas.jasper", param);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdTotalAreas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdTotalAreas dialog = new jdTotalAreas(new javax.swing.JFrame(), true);
