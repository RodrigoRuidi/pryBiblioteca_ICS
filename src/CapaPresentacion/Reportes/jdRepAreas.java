 ...
 */
public class jdRepAreas extends javax.swing.JDialog {

    /**
     * Creates new form jdRepAreas
     */
    public jdRepAreas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            ...
            JRViewer vistaRPT= new clsReporte().reporteInterno("rptAreas.jasper", param);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdRepAreas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdRepAreas dialog = new jdRepAreas(new javax.swing.JFrame(), true);
