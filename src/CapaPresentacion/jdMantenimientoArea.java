...
public class jdMantenimientoArea extends javax.swing.JDialog {
    ...
    /**
     * Creates new form jdMantenimientoArea
     */
    public jdMantenimientoArea(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Mantenimiento de área");
        setResizable(true);
    ...
    private void buscar() {
        ...
        try {
            ...
            if (txtCodigo.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Ingrese el código del área a buscar");
            } else {
                ...
                if (Area != null) {
                    ...
                    jcbVigencia.setSelected(Area.getVigencia());
                    ...
                    JOptionPane.showMessageDialog(this, "No existe el área");
                    limpiar();
                }
    ...
    private void modificar() {
        try {
            if (validarLlenado()) {
                ...
                int confirmacion = JOptionPane.showConfirmDialog(this, "¿Esta seguro de modificar el área ?");
                if (confirmacion == 0) {
                    setear();
                    Boolean res = objA.modificar();
                    if (res) {
                        JOptionPane.showMessageDialog(this, "Se modificó correctamente el área");
                        listar();
                        limpiar();
                    } else {
                        JOptionPane.showMessageDialog(this, "No se modificó el área, intente nuevamente");
                    }
                }
            }
        } catch (Exception e) {
        ...
        try {
            if (txtCodigo.getText().isEmpty()) {
                ...
                if (Area != null) {
                    ...
                    JOptionPane.showMessageDialog(this, "El código del área no existe");
                    limpiar();
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdMantenimientoArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdMantenimientoArea dialog = new jdMantenimientoArea(new javax.swing.JFrame(), true);
